...
INSERT INTO items (name,description,cal,category_id,image_url,price) VALUES ('mushroom soup','basic roux is thinned with cream or milk and then mushrooms and/or mushroom broth are added',39,1,'photos/mushroom.jpg',3.99);
...
INSERT INTO items (name,description,cal,category_id,image_url,price) VALUES ('kabab',' cooked meat dish, with its origins in Middle Eastern cuisine.',144.8,3,'images/kabab.jpg',8.99);
INSERT INTO items (name,description,cal,category_id,image_url,price) VALUES ('burger','  ground meat, typically beef—placed inside a sliced bread roll or bun.',225,3,'images/kabab.jpg',7.99);
...
INSERT INTO items (name,description,cal,category_id,image_url,price) VALUES ('chicken scallop','fried chicken breast',343.9,4,'images/chicken.jpg',7.99);
